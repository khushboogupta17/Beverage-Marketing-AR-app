        ...
        public void Update()
        {
            ...
            foreach (var image in _tempAugmentedImages)
            {
                ...
                if (image.TrackingState == TrackingState.Tracking && visualizer == null)
                {
                    ...
                    coffee.transform.DOShakeRotation(1.5f);
                    Vector3 newPos = new Vector3(anchor.transform.localPosition.x, anchor.transform.localPosition.y , anchor.transform.localPosition.z);
                    coffee.transform.SetPositionAndRotation(newPos, anchor.transform.rotation);

                    var manipulator =
                      Instantiate(ManipulatorPrefab, anchor.transform.position, anchor.transform.rotation);

                    coffee.transform.parent = manipulator.transform;
            ...
            if (coffee.gameObject.activeSelf)
                return;
