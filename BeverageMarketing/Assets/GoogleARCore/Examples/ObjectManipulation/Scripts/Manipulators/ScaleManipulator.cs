...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public class ScaleManipulator : Manipulator
    {
        ...
        {
            base.OnEnable();
            m_CurrentScaleRatio = (transform.GetChild(2).GetChild(0).GetChild(0).localScale.x - MinScale) / ScaleDelta;
        }
        ...
        protected override void OnContinueManipulation(PinchGesture gesture)
        {
            ...
            transform.GetChild(2).GetChild(0).GetChild(0).localScale = new Vector3(currentScale, currentScale, currentScale);
